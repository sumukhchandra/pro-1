// Using a simple component-based approach for icons to easily manage styling and replacement.
// In a real project, you would use a library like lucide-react.
// This is a simplified version for self-containment.
...
export const Settings: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19.14 12.94c.04-.3.06-.61.06-.94s-.02-.64-.07-.94l2.03-1.58a.5.5 0 0 0 .12-.63l-1.38-2.4a.5.5 0 0 0-.63-.12l-2.4 1.38c-.37-.28-.77-.52-1.2-.7l-.4-2.64A.5.5 0 0 0 15 2H9a.5.5 0 0 0-.5.46l-.4 2.64c-.43.18-.83.42-1.2.7l-2.4-1.38a.5.5 0 0 0-.63.12L2.48 7.37a.5.5 0 0 0 .12.63l2.03 1.58c-.05.3-.07.64-.07.94s.02.64.07.94l-2.03 1.58a.5.5 0 0 0-.12.63l1.38 2.4a.5.5 0 0 0 .63.12l2.4-1.38c.37.28.77.52 1.2.7l.4 2.64a.5.5 0 0 0 .5.46h6a.5.5 0 0 0 .5-.46l.4-2.64c.43-.18.83.42 1.2-.7l2.4 1.38a.5.5 0 0 0 .63-.12l1.38-2.4a.5.5 0 0 0-.12-.63l-2.03-1.58z"/><circle cx="12" cy="12" r="3.5"/></svg>
);
...
export const Box: React.FC<IconProps> = ({ className }) => (
...
const ICONS: { [key: string]: React.FC<IconProps> } = {
  Edit3, Palette, Type, Box, Globe, PlayCircle,
};
